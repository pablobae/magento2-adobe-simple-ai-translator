...
class DeeplTargetLanguages implements OptionSourceInterface
{
    /**
    ...
    public function toOptionArray()
    {
        return [
            ...
            ['value' => 'EN-GB', 'label' => __('English (British)')],
            ['value' => 'EN-US', 'label' => __('English (American)')],
            ...
            ['value' => 'PT-BR', 'label' => __('Portuguese (Brazilian)')],
            ['value' => 'PT-PT', 'label' => __('Portuguese (European)')],
